  ...
  getInstructions(miniGameType) {
    const instructions = {
      ...
      'doppel-kategorie': 'Ein Wort muss gleich zwei Filter bestehen.',
	      ...
	      'kartenlupe-wortfang': 'Betrachte den echten Kartenausschnitt und waehle das passende Wort.',
	      'wortkarten-blitzwahl': 'Lies den Hinweis und waehle aus vier echten Wortkarten.',
	      ...
	      'silben-klatschkarten': 'Sprich die Wortkarte und waehle die richtige Silbenzahl.',
	      'anfangsbuchstaben-lupe': 'Sieh durch die Lupe und waehle den Anfangsbuchstaben.',
	      ...
	      'figuren-satztheater': 'Waehle den Satz, der zur Figur passt und grammatisch sauber ist.',
      'wortkarten-domino': 'Lege die S-Wortkarten von kurz bis lang als Domino.',
      'bildwort-galerie': 'Sieh genau hin und waehle das passende Wort zum markierten Aquarellobjekt.',
      ...
      'dialog-spotlight': 'Waehle die Antwort, die zur Rolle und Szene passt.',
      word_ending: 'Treffe die geforderte Endung und halte die Wortlaenge sauber.',
      word_length_hunt: 'Jage ein Wort mit exakt der geforderten Buchstabenlaenge.',
      forbidden_letter_trap: 'Passe zur Aufgabe, aber beruehre den Tabu-Buchstaben nicht.',
      prefix_duel: 'Finde unter Druck ein Wort mit dem geforderten Praefix.',
