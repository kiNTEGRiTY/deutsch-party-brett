...
const TOPIC_MINIGAME_MAP = {
  nomen:          ['karten-klick-labor', 'kartenlupe-wortfang', 'wortkarten-blitzwahl', 'artikel-stempelstudio', 'artikel-sortierband', 'tierblatt-spurensuche', 'bildwort-galerie', 'artikel-bildjagd', 'wortarten-sprunglauf', 'wortarten-band', 'artikel-atelier', 'wortarten-orchester', 'sentence-stacker', 'scrap-hunt', 'word-type-sort', 'noun-hunter', 'word-ninja', 'gender-sort', 'plural-match', 'whack-a-noun', 'word-avalanche', 'substantiv-only'],
  verben:         ['wortarten-sprunglauf', 'wortarten-band', 'verb-takt', 'satz-flickwerk', 'wortarten-orchester', 'sentence-stacker', 'word-type-sort', 'word-ninja', 'verb-pulse', 'tense-switcher', 'word-family-tree', 'verb-only'],
