...
const TOPIC_MINIGAME_MAP = {
  nomen:          ['karten-klick-labor', 'kartenlupe-wortfang', 'wortkarten-blitzwahl', 'artikel-stempelstudio', 'artikel-sortierband', 'tierblatt-spurensuche', 'bildwort-galerie', 'artikel-bildjagd', 'wortarten-band', 'artikel-atelier', 'wortarten-orchester', 'sentence-stacker', 'scrap-hunt', 'word-type-sort', 'noun-hunter', 'word-ninja', 'gender-sort', 'plural-match', 'whack-a-noun', 'word-avalanche', 'substantiv-only'],
  verben:         ['wortarten-band', 'verb-takt', 'satz-flickwerk', 'wortarten-orchester', 'sentence-stacker', 'word-type-sort', 'word-ninja', 'verb-pulse', 'tense-switcher', 'word-family-tree', 'verb-only'],
  adjektive:      ['wortarten-band', 'wortarten-orchester', 'wortfunkeln', 'satz-flickwerk', 'sentence-stacker', 'word-type-sort', 'adjective-painter', 'word-balance', 'bubble-burst'],
  ...
  wortarten:      ['wortarten-band', 'wortarten-orchester', 'sentence-stacker', 'word-type-sort', 'word-ninja', 'whack-a-noun', 'bubble-burst', 'word-avalanche', 'word-chess', 'blitz-quiz', 'gravity-sort', 'mad-libs-de', 'tap-the-type', 'gender-gym', 'article-ace', 'word-fishing', 'suffix-sun', 'kitchen-chaos', 'mystery-box', 'verb-only', 'substantiv-only'],
