...
import { GameController } from './engine/game-controller.js?v=board-material-cards-49';
...
class App {
  ...
  async _mountStartPreview() {
    ...
    try {
      const { mountStartPreview } = await import('./ui/render-start-preview.js?v=board-material-cards-49');
  ...
  _applyDebugRoute() {
    ...
    window.setTimeout(async () => {
      const { getMinigame } = await import('./minigames/minigame-registry.js?v=board-material-cards-49');
  ...
  async _getSetupRendererClass() {
    if (!this._setupRendererClass) {
      const module = await import('./ui/render-setup.js?v=board-material-cards-49');
  ...
  async _getBoardRendererClass() {
    if (!this._boardRendererClass) {
      const module = await import('./ui/render-board.js?v=board-material-cards-49');
  ...
  async _getMinigameRendererClass() {
    if (!this._minigameRendererClass) {
      const module = await import('./ui/render-minigame.js?v=board-material-cards-49');
  ...
  async _getMinigameMenuRendererClass() {
    if (!this._minigameMenuRendererClass) {
      const module = await import('./ui/render-minigame-menu.js?v=board-material-cards-49');
